...
export function SearchFilterBar({ isScrolled, onSearch }: SearchFilterBarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Filter Cepat Floating Popover (Melayang tanpa mengubah tinggi search bar atau menggeser layout / chart) */}
      {isSearchExpanded && (
          ...
          <div className="flex w-full gap-[8px] sm:gap-[16px] justify-between">
            ...
            <div className="flex-1 text-left min-w-0">
              ...
              <Button
                type="button"
                variant="outline"
                className="flex items-center justify-between w-full h-[37px] px-2 sm:px-[18px] bg-white/5 border border-white/10 rounded-[12px] text-neu-300 text-[12px] font-normal leading-[18px] text-left backdrop-blur-[14px] hover:bg-white/10 hover:text-white cursor-pointer"
              >
